...
export default function App() { // Or function Index()
  
  useEffect(() => {
    // 1. Check your cookie choice
    const cookieConsent = localStorage.getItem("bk-cookie-accepted");

    // 2. Create the main script tag for Google Analytics
    const script1 = document.createElement('script');
    script1.async = true;
    script1.src = "https://www.googletagmanager.com/gtag/js?id=G-H3LY26B8FD"; // Replace with your ID
    document.head.appendChild(script1);

    // 3. Create the initialization logic script
    ...
    // Optional Cleanup: Removes scripts if the component unmounts
    return () => {
  ...
  // Your existing Lovable component JSX continues below untouched...
  return (
    <div>
       {/* Existing code... */}
    </div>
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "B2B/B2C Enterprise & Local Trade Digital Marketing | Blackwood Keep" },
      {
        name: "description",
        content:
          "Blackwood Keep engineers high-converting marketing funnels, local SEO optimisation, and scalable acquisition strategies for trades, facilities management, and B2B/B2C enterprises across the North West. Book your pipeline audit.",
      },
      {
        property: "og:title",
        content: "B2B/B2C Enterprise & Local Trade Digital Marketing | Blackwood Keep",
      },
      {
        property: "og:description",
        content:
          "Marketing clarity. Measurable growth. Predictable pipeline for trades, FM, and B2B/B2C enterprises across the Wirral, Liverpool, Chester, Cheshire West, Cheshire East, and North Wales.",
      },
    ...
    <PageLayout>
      ...
      >
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <p className="mt-6 text-muted-foreground" style={{ fontSize: "1.125rem", maxWidth: "720px", lineHeight: 1.6 }}>
            ...
            B2B/B2C enterprises across the Wirral, Liverpool, Chester, Cheshire West, Cheshire East, and North Wales.
          </p>
      ...
      <section style={{ backgroundColor: slate }} className="px-6 py-20">
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-0 md:grid-cols-2 md:items-stretch">
          ...
          />
          <SegmentCard
            heading="B2B/B2C Enterprise & Infrastructure"
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3 md:items-stretch">
            ...
            <ProblemCard
              ...
              solution="We measure contract wins, not clicks."
            />
            <ProblemCard
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3 md:items-stretch">
            ...
            <SectorCard
              ...
              body="Establish absolute regional authority across the Wirral, Liverpool, Chester, Cheshire West, Cheshire East, and North Wales. We automate five-star review loops and optimise your local search profile to guarantee you are the primary firm selected."
            />
            <SectorCard
              icon={<TrendingUp size={28} className="bwk-icon-accent" />}
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3 md:items-stretch">
            <TestimonialCard
              ...
              statement="Starting out in a highly competitive market can feel completely overwhelming for any enterprise or new venture."
              quote="I initially felt overwhelmed by everything that needed to be done... Maggie’s ability to take the pressure off me brought structure and direction when I needed it most."
            />
            <TestimonialCard
              icon={<ShieldCheck size={28} className="bwk-icon-accent" />}
              title="Engineering the Roadmap"
              statement="Growth requires an objective, predictable framework backed by clear, measurable performance indicators."
              quote="She developed a complete digital marketing campaign, a strategic marketing plan, and a detailed 12-month growth roadmap with clear, actionable KPIs."
            />
            <TestimonialCard
              icon={<Rocket size={28} className="bwk-icon-accent" />}
              title="Total Business Alignment"
              statement="A successful strategy must be immediately actionable, lifting the baseline performance of the business."
              quote="Everything was delivered to an exceptionally high standard. It gave me both clarity and confidence, bringing a real sense of momentum aligned with my goals."
            />
          </div>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 md:grid-cols-2">
          ...
          <div className="bwk-card">
            ...
            <ul className="mt-4 space-y-3 text-muted-foreground" style={{ fontSize: "1.0625rem" }}>
              ...
              <li className="flex gap-3">
                <Check size={18} className="bwk-icon-accent" style={{ flexShrink: 0, marginTop: 3 }} />
                <span>High-Growth B2B/B2C Operations seeking automated pipeline stability</span>
              </li>
            </ul>
          </div>
        </div>
...
function TestimonialCard({ icon, title, statement, quote }: { quote: string; attr: string }) {
  return (
    <div className="bwk-card">
      <div>
        {icon}
      </div>
      <h3 className="mt-4" style={{ fontSize: "1.25rem" }}>{title}</h3>
      <p className="mt-2 text-muted-foreground" style={{ fontSize: "1rem", lineHeight: 1.7 }}>
        {statement}
      </p>
      <p className="bwk-attr mt-4" style={{ fontStyle: "italic"}}>“ {quote} ”</p>
    </div>
  );
}
